	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002cc:	8d 8e 71 f3 ff ff    	lea    -0xc8f(%esi),%ecx
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800427:	8b 84 38 98 f3 ff ff 	mov    -0xc68(%eax,%edi,1),%eax
...
008004e6 <.L28>:
  ...
  800507:	53                   	push   %ebx
  800508:	8d 87 82 f3 ff ff    	lea    -0xc7e(%edi),%eax
  80050e:	50                   	push   %eax
  ...
  80051d:	e9 35 02 00 00       	jmp    800757 <.L20+0x28>
				printfmt(putch, putdat, "%s", p);
  800522:	56                   	push   %esi
  800523:	8d 87 8b f3 ff ff    	lea    -0xc75(%edi),%eax
  800529:	50                   	push   %eax
...
0080053d <.L24>:
  ...
  80054a:	75 06                	jne    800552 <.L24+0x15>
				p = "(null)";
  80054c:	8d b7 8e f3 ff ff    	lea    -0xc72(%edi),%esi
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800f29:	8d 83 f0 f4 ff ff    	lea    -0xb10(%ebx),%eax
  800f2f:	50                   	push   %eax
  800f30:	6a 23                	push   $0x23
  800f32:	8d 83 0d f5 ff ff    	lea    -0xaf3(%ebx),%eax
  800f38:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80103e:	56                   	push   %esi
  80103f:	50                   	push   %eax
  801040:	8d 83 1c f5 ff ff    	lea    -0xae4(%ebx),%eax
  801046:	50                   	push   %eax
  ...
  801064:	8d 83 3f f5 ff ff    	lea    -0xac1(%ebx),%eax
  80106a:	50                   	push   %eax
