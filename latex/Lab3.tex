...
\exercise{4}{
        \par 
        {
            ...
            The macros \textbf{TRAPHANDLER} and \textbf{TRAPHANDLER\_NOEC} in trapentry.S 
            ...
            the \textbf{SETGATE} macro will be helpful here.
        } \par
        {
...
参考xv6源码，对 \_\_alltraps 补充如下：\par
\lstset{style=AssemblyStyle}
\setmainfont{Consolas}
\begin{lstlisting}
 .global _alltraps
